...
namespace intro_ef.Migrations
{
    ...
    [Migration("20240911093615_TablesSalesRelation")]
    partial class TablesSalesRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("intro_ef.Models.Sale", b =>
                {
                    b.HasOne("intro_ef.Models.Customer", "Customer")
                        .WithOne("SaleC")
                        .HasForeignKey("intro_ef.Models.Sale", "CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("intro_ef.Models.Product", "Product")
                        .WithOne("SaleP")
                        .HasForeignKey("intro_ef.Models.Sale", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("intro_ef.Models.Store", "Store")
                        .WithOne("SaleS")
                        .HasForeignKey("intro_ef.Models.Sale", "StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
